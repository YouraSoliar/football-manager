...
public class PlayerController {
    ...
    public PlayerDto createPlayer(@RequestBody CreatePlayerRequestDto requestDto) {
        return playerService.save(requestDto);
    }

    @PutMapping("/{id}")
    public PlayerDto updatePlayer(@PathVariable Long id, @RequestBody CreatePlayerRequestDto requestDto) {
